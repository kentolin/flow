...
export function enableZoomPan(svg) {
  ...
  // Helper to update CSS grid fade
  function updateGridOpacity(scale) {
    let fineOpacity, mainOpacity;
    ...
    flowchart?.style.setProperty("--fine-opacity", fineOpacity);
    flowchart?.style.setProperty("--main-opacity", mainOpacity);
  }
  ...
  svg.addEventListener(
    ...
    (e) => {
      ...
      // 🔹 Update zoom scale and grid appearance
      state.zoomScale *= factor;
      updateGridOpacity(state.zoomScale);
